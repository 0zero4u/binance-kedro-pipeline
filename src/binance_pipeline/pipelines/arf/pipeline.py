...
def create_pipeline(**kwargs) -> Pipeline:
    return pipeline([
        # 1. Split data from the main DE pipeline
        node(
            func=split_data,
        ...
        # 4. Apply scaling to TRAINING data
        node(
        ...
        # 9. Apply the FITTED scaler to TEST data
        node(
            func=apply_robust_scaling,
